...
/**
 * A {@link android.preference.DialogPreference} that provides a user with the means to select an integer from a {@link android.widget.NumberPicker}, and persist it.
 *
 * @author lukehorvat
 *
 */
